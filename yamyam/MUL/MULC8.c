...
void MULC(bigint **C, bigint *A, bigint *B)
{
    ...
    for (int j = 0; j < n; j++)
        for (int i = 0; i < m; i++)
        {
            ...
            printf("%d-th T = ", j * m + i);
            show64(T);
            // printf("wordlen T: %d, C: %d\n", T->wordlen, (*C)->wordlen);

            for (int k = 4; k < (*C)->wordlen; k++)
                (*C)->a[k] = 0;
...
int main()
{
    ...
    */
    char *str1[4] = {
        "0xaaaaaaaaaaaaa12424112434231423423142343243214321432432aaa", "0xaaaaffffa4352435524334552345342523aaaffff", "0x1234"};
    // char *str1[4] = {
