...
void MULC(bigint **C, bigint *A, bigint *B)
{
    ...
    for (int j = 0; j < n; j++)
        for (int i = 0; i < m; i++)
        {
            ...
            printf("%d-th T = ", j * m + i);
            show64(T);
            // (*C)->wordlen = T->wordlen + 1;

            // printf("as%d-th C = ", j * m + i);
            // show64(*C);
            /*
            printf("C wordlen: %d\n", (*C)->wordlen);
            */
...
int main()
{
    ...
    */
    ...
    char *str1[4] = {
        "0xaaaaaaaaaaaaa12424112434231423423142343243214321432432aaa",
        "0xaaaaffffa4352435524334552345342523aaaffff",
        "0x1234",
    };
    // char *str1[4] = {
    //     "0xffffffffffffffffffffffffffffffff", "0x1", "0x1234"};
    //    char *str1[4] = {
